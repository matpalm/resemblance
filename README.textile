...
<pre>
> cat result | ./examine_result.rb test.data
</pre>
...
<pre>
> cat test.data | ./shingle.rb coeff 0.5 | sort -n -k3 | tac > shingling.result
> cat test.data | ./simhash.rb | sort -n -k3 | tac > simhash.result
